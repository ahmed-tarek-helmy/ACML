          ...
          <div className="prose prose-lg dark:prose-invert max-w-none text-gray-700 dark:text-gray-300">
            ...
            <div className="clearfix mb-8">
              ...
              <p className="mb-6 leading-relaxed">
                IHS ESDU provides engineering insight based on the collective
                knowledge of hundreds of engineers from around the world. It is
                actively managed and updated regularly to keep abreast of the
                latest science and practices to deliver the most advanced
                resources.
              </p>
              <p className="mb-6 leading-relaxed">
            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 p-6 rounded-xl mb-8">
              ...
              <ul className="grid md:grid-cols-2 gap-4">
                <li className="flex items-start">
                  ...
                  <span>
                    Detailed descriptions of the principles on which methods are
                    based
                  </span>
                </li>
                <li className="flex items-start">
            ...
            <div className="bg-emerald-50 dark:bg-emerald-900/20 p-6 rounded-xl border-l-4 border-emerald-500 mb-8">
              <p className="leading-relaxed">
                ...
                team can eliminate dependence on outdated or inaccurate methods
                to move from research and development through design and
                certification as effectively as possible.
              </p>
            </div>
            ...
            <div className="mb-12">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">
                Design Engineers worldwide rely on IHS ESDU Aerodynamics Design
                tools
              </h3>
              ...
              <div className="space-y-6">
                <div className="bg-gray-50 dark:bg-gray-700/50 p-6 rounded-xl">
                  ...
                  <p className="leading-relaxed">
                    ...
                    aerospace design and performance topics. IHS ESDU is the
                    ideal complement to other design tools such as finite
                ...
                <div className="bg-gray-50 dark:bg-gray-700/50 p-6 rounded-xl">
                  ...
                  <p className="leading-relaxed">
                    IHS ESDU provides an in-depth discussion of the relevant
                    design parameters and the tools to research alternative
                    configurations to optimize the design
                  </p>
                </div>
                ...
                <div className="bg-gray-50 dark:bg-gray-700/50 p-6 rounded-xl">
                  ...
                  <p className="leading-relaxed mb-4">
                    IHS ESDU methods and data enable cooperation on joint
                  ...
                  <p className="leading-relaxed mb-4">
                    Because IHS ESDU methods are validated, calculations will
                    accurately predict performance with less rework or reliance
                  ...
                  <p className="leading-relaxed">
                    IHS ESDU helps engineers effectively solve complex problems
                    to shorten the initial design and development phases and
