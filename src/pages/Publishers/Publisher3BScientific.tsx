        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-100 dark:border-gray-700 hover:shadow-md transition-shadow group">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                Wide range of supplies including needles (Seirin, Moxom),
                charts, models, cupping glasses, and laser devices.
              </p>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-100 dark:border-gray-700 hover:shadow-md transition-shadow group">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                Extensive collection of charts and posters for anatomy,
          ...
          <div className="bg-gray-100 dark:bg-gray-800 rounded-2xl p-8 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              ...
              UK, Russia, Brazil, Thailand, South Korea, and Turkey, 3B
              Scientific serves customers in over 100 countries.
            </p>
          </div>
        </div>
      </div>
