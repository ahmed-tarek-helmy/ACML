            ...
            <section>
              ...
              <div className="prose prose-lg dark:prose-invert max-w-none text-gray-600 dark:text-gray-300">
                <p className="mb-4">
                  ...
                  conducting test methods within their own laboratories when
                  their data are compared against other laboratories that
                  participate worldwide in the same program.
                </p>
                <p className="mb-4">
                  ...
                  your own facility using the specified ASTM methods cited in
                  the program. Upon completing the tests, each laboratory
