            ...
            <div className="md:col-span-2">
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-8 border border-gray-100 dark:border-gray-700 mb-8">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-6 font-medium">
                  ...
                  with a range of software packages suitable for small
                  businesses to global enterprises. This includes data services
                  and integrations with third party ERPs such as SAP.
                </p>
                ...
                <div className="space-y-8">
                  <div className="border-l-4 border-emerald-500 pl-6 py-2">
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      ...
                      top of SDS, this includes risk assessment reports and
                      label generation, chemical registers, and manifests.
                    </p>
                  </div>
                  ...
                  <div className="border-l-4 border-emerald-500 pl-6 py-2">
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Free trial of Backpack, up to 50 chemicals. Create your
                      own Chemicals Inventory System for FREE
                    </p>
                  </div>
                  ...
                  <div className="border-l-4 border-emerald-500 pl-6 py-2">
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Chemeritus combines chemicals management with
                      comprehensive supply chain solutions. This includes
                      approvals, reports and documentation, SiSoT (Scan in Scan
                      out Technology), and web services API integration.
                    </p>
                  </div>
                  ...
                  <div className="border-l-4 border-emerald-500 pl-6 py-2">
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      ...
                      tools and a step-by-step method for authoring, archiving
                      and updating your SDS, AuthorITe meets the needs of the
                      modern chemist.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-8 border border-gray-100 dark:border-gray-700 mt-8">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  Smarter Suite is Chemwatch’s chemicals management mobile app.
                  It combines the features of our current apps, SmartSuite and
                  SiSoT mobile, enabling accessibility from a single location.
                  Smarter Suite is a one-stop-shop for clients to access
                  extensive health and safety information, including Risk
                  Assessments, and to manage their chemical inventory, using
                  barcoding via SiSoT.
                </p>
              ...
              <div className="bg-blue-900 text-white rounded-2xl shadow-xl p-8 mt-8 text-center">
                ...
                <p className="text-lg mb-8 opacity-90">
                  With access to more than 150 million Chemical SDS, you can't
                  go wrong!
                </p>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600 dark:text-gray-400">
                      ...
                      name, synonym, chemical formula, or manufacturer's name.
                      The "Product Screen" typically refers to the display of
                      search results, where you can view and select specific
                      chemical or product.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-xs text-gray-600 dark:text-gray-400">
                      These columns can be customized by right-clicking within
                      the table. This table provides a central location to view
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600 dark:text-gray-400">
                      ...
                      organization generally, users will use the Folders
                      directory when separating materials based on internal
                      departments or non-site-specific details.
                    </p>
                  </div>
                  <div>
                    <h4 className="font-bold text-gray-800 dark:text-white text-sm mb-1">
                    ...
                    <p className="text-xs text-gray-600 dark:text-gray-400">
                      Once we have found our correct material with the correct
                      CAS (Chemical Abstracts Service) number, we need to select
                      the material, to go into the documents table, to specify a
                      vendor.
                    </p>
                    ...
                    <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">
                      otherwise, you will copy all vendors and their
                      corresponding SDS for that material.
                    </p>
                  </div>
                  <div>
                    <h4 className="font-bold text-gray-800 dark:text-white text-sm mb-1">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600 dark:text-gray-400">
                      ...
                      information to be shown in the Chemwatch Gold SDS as well
                      as set preferred vendors for these documents.
                    </p>
                  </div>
                  <div>
                    <h4 className="font-bold text-gray-800 dark:text-white text-sm mb-1">
                    ...
                    <p className="text-xs text-gray-600 dark:text-gray-400">
                      The user access settings contain all the necessary steps
                      to create new users, assign permissions and determine site
                      access for users.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-xs text-gray-600 dark:text-gray-400">
                      Approvals enable businesses and organizations to establish
                      a workflow whereby new materials can be scrutinized and
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600 dark:text-gray-400">
                      ...
                      unlimited amount of data from the materials SDS Reports
                      will be generated from the database.
                    </p>
                  </div>
                  <div>
                    <h4 className="font-bold text-gray-800 dark:text-white text-sm mb-1">
                    ...
                    <p className="text-xs text-gray-600 dark:text-gray-400">
                      In this module you can look for a material using the
                      screen panel or look for an existing material from your
                      folders or manifest using the tree panel.
                    </p>
                  </div>
                  <div>
                    <h4 className="font-bold text-gray-800 dark:text-white text-sm mb-1">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600 dark:text-gray-400">
                      ...
                      waste codes, and definitions provided by certified
                      chemists. Benefit from advanced life-cycle tracking, waste
                      burden assessments, and reporting aligned with CSRD and
                      GRI 306.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-xs text-gray-600 dark:text-gray-400">
                      ...
                      dashboard insights, and immediate alerts when sites
                      approach regulatory limits. Full audit trails help with
                      root cause analysis, while risk-based alerts identify
                      potential reproductive hazards and suggest administrative
                      controls.
                    </p>
                  </div>
                </div>
