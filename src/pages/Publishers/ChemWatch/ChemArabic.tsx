          ...
          <div className="md:flex">
            <div className="p-8 md:p-12 md:w-2/3">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed font-arabic">
                ...
                الإدارة الكيميائية الخاصة بك. تحتفظ Chemwatch بأكبر قاعدة بيانات
                للمواد الكيميائية في العالم ، مع أكثر من 3,215,992 مادة ، و 140
                مليون SDS (ورقة بيانات السلامة) ، وحلول تنظيمية كيميائية تدعم
                المتطلبات المحلية والعالمية في أكثر من 90 دولة. تعد Chemwatch
                الشركة الرائدة عالميًا في مجال حلول إدارة المواد الكيميائية.
                يمنح الوصول إلى قاعدة البيانات الشاملة هذه العملاء ميزة فريدة
                على غيرهم من مقدمي الخدمات الكيميائية.
              </p>
            </div>
          ...
          <div className="md:col-span-2">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-8 border border-gray-100 dark:border-gray-700 mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6 font-medium font-arabic">
                توفر Chemwatch حلولاً شاملة لإدارة المواد الكيميائية ، مع مجموعة
                من حزم البرامج المناسبة للشركات الصغيرة للمؤسسات العالمية. يتضمن
                ذلك خدمات البيانات وعمليات التكامل مع أنظمة تخطيط موارد المؤسسات
                (ERP) التابعة لجهات خارجية مثل SAP.
              </p>
              ...
              <div className="space-y-8">
                ...
                <div className="border-r-4 border-emerald-500 pr-6 py-2">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 font-arabic">
                    ...
                    مع تحديثات أسبوعية تلقائية. جربه مجانًا إذا كان لديك أقل من
                    50 SDS للمحافظة عليه.
                  </p>
                </div>
                ...
                <div className="border-r-4 border-emerald-500 pr-6 py-2">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 font-arabic">
                    تجربة مجانية لحقيبة الظهر ، حتى 50 مادة كيميائية. قم بإنشاء
                    نظام جرد المواد الكيميائية الخاص بك مجانًا
                  </p>
                </div>
                ...
                <div className="border-r-4 border-emerald-500 pr-6 py-2">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mb-2 font-arabic">
                    هي طريقة سهلة لتأليف صحيفة بيانات سلامة المواد للمنتجات التي
                    تقوم بتصنيعها.
                  </p>
                  <p className="text-gray-600 dark:text-gray-300 font-arabic">
                    مليئة بالمواد المصنفة مسبقًا وأدوات الاقتراح المفيدة وطريقة
                    خطوة بخطوة لتأليف وأرشفة وتحديث صحيفة بيانات سلامة المواد
                    الخاصة بك ، يلبي AuthorITe احتياجات الكيميائي الحديث.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-8 border border-gray-100 dark:border-gray-700 mt-8 text-right">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-gray-50 dark:bg-gray-700/30 p-6 rounded-xl">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm font-arabic">
                    أداة Smart Audit New Service (AaaS) الجديدة من Chemwatch هي
            ...
            <div className="bg-blue-900 text-white rounded-2xl shadow-xl p-8 mt-8 text-center font-arabic">
              ...
              <p className="text-lg mb-8 opacity-90">
                تستخدم منتجات وخدمات Chemwatch عالميا من قبل أكثر من 5000 مؤسسة.
              </p>
              ...
              <div className="space-y-4 font-arabic">
                <div>
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400">
                    يتضمن جميع العناصر المرئية مثل الإعدادات والتعليم الإلكتروني
                    والمساعدة واللغة التي يتفاعل معها المستخدمون للنظام.
                  </p>
                </div>
                <div>
                  <h4 className="font-bold text-gray-800 dark:text-white text-sm mb-1">
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400">
                    ...
                    إلى عرض نتائج البحث ، ومن ثم يتم تحديد المادة الكيميائية أو
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400">
                    يمكن تخصيص هذه الأعمدة عن طريق النقر بزر الماوس الأيمن داخل
                    الجدول. يوفر هذا الجدول موقعا مركزيا لعرض المعلومات
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400">
                    ...
                    المجلدات عند فصل المواد على أساس الإدارات الداخلية أو تفاصيل
                    غير محددة الموقع.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400">
                    ...
                    البحث عن المواد، ولكن ستقوم بنسخ جميع البائعين وصحيفة بيانات
                    السلامة الخاصة بهم لتلك المادة.
                  </p>
                </div>
                <div>
                  <h4 className="font-bold text-gray-800 dark:text-white text-sm mb-1">
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400">
                    تحدد وحدة تقييم المخاطر ما إذا كنت ستكمل تقييم المخاطر بناء
                    على معايير منظمة العمل الدولية للمواد الخطرة أو وفقا لمعايير
                    الأمم المتحدة للبضائع الخطرة.
                  </p>
                </div>
                <div>
                  <h4 className="font-bold text-gray-800 dark:text-white text-sm mb-1">
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400">
                    يمكن إعطاء الأسماء المفضلة لمواد أو مستندات بائع محددة ليتم
                    استبدال اسم المادة في جدول البحث عن المواد.
                  </p>
                </div>
                <div>
                  <h4 className="font-bold text-gray-800 dark:text-white text-sm mb-1">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400">
                    تسمح للمتسخدم بتعيين نوع المعلومات التي سيتم عرضها في صحيفة
                    بيانات السلامة بالإضافة إلي تعيين البائعين المفضلين لهذه
                    المستندات.
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400">
                    ...
                    واكودها، والتعريفات التي يقدمها الكيميائيون المعتمدون. استفد
                    من التتبع المتقدم لدورة الحياة، وتقييمات عبء النفايات،
                    وإعداد التقارير بما يتماشى مع <span dir="ltr">CSRD</span> و{" "}
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400">
                    رفع مستوى تقييمات المخاطر من خلال المراقبة في الوقت الفعلي،
                    ورؤى لوحة المعلومات، والتنبيهات الفورية عندما تقترب المواقع
                    من الحدود التنظيمية ، وتساعد مسارت التدقيق الكاملة في تحليل
                    السبب الجذري، بينما تحدد التنبيهات القائمة المخاطر الإنجابية
                    المحتملة وتقترح ضوابط إدارية.
                  </p>
                </div>
              </div>
            </div>
