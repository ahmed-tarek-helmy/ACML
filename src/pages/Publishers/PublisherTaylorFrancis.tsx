                ...
                <ul className="space-y-4">
                  <li className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
                    ...
                    <span className="text-gray-600 dark:text-gray-300 text-sm">
                      ...
                      Press, Gordon & Breach, Harwood Academic, RoutledgeCurzon,
                      CRC Press, Frank Cass and BIOS Scientific Publishers.
                    </span>
                  </li>
                  <li className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
                    <strong className="block text-emerald-600 dark:text-emerald-400 mb-1">
              ...
              <div className="grid grid-cols-1 gap-6">
                ...
                <div className="flex flex-col md:flex-row gap-6 p-6 border border-gray-100 dark:border-gray-700 rounded-xl hover:shadow-md transition-shadow">
                  ...
                  <div className="md:w-2/3">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 text-sm">
                      An interactive online library for all of the countries and
                      territories of each of the world regions.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row gap-6 p-6 border border-gray-100 dark:border-gray-700 rounded-xl hover:shadow-md transition-shadow">
                  ...
                  <div className="md:w-2/3">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 text-sm">
                      A Comprehensive directory of almost 60,000 of the world's
