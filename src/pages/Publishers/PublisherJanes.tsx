          ...
          <div className="bg-gradient-to-r from-green-900 to-emerald-900 text-white py-20 mb-12 rounded-3xl overflow-hidden shadow-xl">
            <div className="container mx-auto px-4 text-center">
              ...
              <p className="text-lg md:text-xl text-emerald-100 max-w-3xl mx-auto leading-relaxed">
                The trusted source for defense and security intelligence, as
                well as transportation news and reference.
              </p>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 space-y-12 text-gray-700 dark:text-gray-300 border border-gray-100 dark:border-gray-700">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4 flex items-center">
                ...
                Accuris Jane's Defense & Security
              </h2>
            ...
            <section>
              ...
              <p className="mb-6">
                ...
                analyze major commercial transportation issues affecting air,
                land and sea.
              </p>

              <div className="bg-gray-50 dark:bg-gray-700/50 p-6 rounded-xl mb-8">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">
                  Accuris Jane's Transportation News & Reference solutions
                  enable you to:
                </h3>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-6 rounded-xl hover:shadow-md transition-shadow">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Systematizes key ATC equipment, technology and market data
                    for more than 600 specialist manufacturers.
                  </p>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-6 rounded-xl hover:shadow-md transition-shadow">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
                    Details more than 2,100 major airports and over 3,800
                    handling agents on six continents.
                  </p>
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    <strong>Jane's Airports and Handling Agents</strong> is an
                    in-depth flight planning publication providing all the
                    details you need regarding the world's major airports,
                    fixed-based operators and handling agents.
                  </p>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-6 rounded-xl hover:shadow-md transition-shadow">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
                    Definitive guide to products and services from more than
                ...
                <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-6 rounded-xl hover:shadow-md transition-shadow">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    ...
                    arrangers and lenders for debt deals in the aircraft,
                    airport, shipping and rail rolling stock sectors.
                  </p>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-6 rounded-xl hover:shadow-md transition-shadow">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Global synopsis of 1,500 manufacturers and city-by-city
                    guide of current fleets and future operations.
                  </p>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-6 rounded-xl hover:shadow-md transition-shadow">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Combines 18 transport-related reference products covering
                    air, land and sea. Clients may create their own bespoke
                    collection.
                  </p>
                </div>
