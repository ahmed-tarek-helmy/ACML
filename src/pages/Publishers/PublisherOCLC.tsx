        ...
        <div className="bg-gradient-to-r from-green-800 to-teal-800 text-white py-20 mb-12 rounded-3xl overflow-hidden shadow-xl">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg md:text-xl text-green-100 max-w-3xl mx-auto leading-relaxed">
              ...
              services, original research, and community programs.
            </p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 space-y-12 text-gray-700 dark:text-gray-300 border border-gray-100 dark:border-gray-700">
          ...
          <section>
            <div className="prose prose-lg dark:prose-invert max-w-none text-gray-600 dark:text-gray-300">
              ...
              <p className="mb-4">
                More than 57,000 libraries in 112 countries use OCLC services to
          ...
          <section>
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-8 text-center max-w-4xl mx-auto">
              ...
              Enhance processes. Extend collections and access. Strengthen your
              users' experience. Individually, our solutions create tangible
              benefits for nearly every aspect of library management. Combined,
              they offer unparalleled efficiencies, economy and a quality of
              service that will bring patrons back again and again
            </p>
