          ...
          <div className="bg-gradient-to-r from-blue-900 to-cyan-900 text-white py-20 mb-12 rounded-3xl overflow-hidden shadow-xl">
            <div className="container mx-auto px-4 text-center">
              ...
              <p className="text-lg md:text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
                Building cooperation between mathematics and the worlds of
                science and technology through research, publications, and
                community.
              </p>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-8 border border-gray-100 dark:border-gray-700">
                ...
                <div className="prose prose-lg dark:prose-invert max-w-none text-gray-600 dark:text-gray-300">
                  ...
                  <p className="mb-4">
                    ...
                    an international community of over 14,000 individual
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300">
                      ...
                      presentation of original research in the implementation
                      and experimental evaluation of algorithms and data
                      structures.
                    </p>
                  </div>
                ...
                <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300 ml-4">
                  ...
                  <li className="flex items-start">
                    ...
                    <span>
                      ...
                      educational, and scientific -- that affect the
