                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-6">
                  <div className="prose prose-lg dark:prose-invert max-w-none text-gray-600 dark:text-gray-300">
                    <p className="mb-6">
                      ...
                      served in its capacity as administrator and coordinator of
                      ...
                      organization supported by a diverse constituency of
                      private and public sector organizations. ANSI also
                      represents the U.S. in international standardization
                      forums, providing access to global standards, guidelines,
                      statistics and international standards compiled by and/or
                      its member bodies.
                    </p>
                    <p className="mb-6">
                      ...
                      company, organization, government agency, institutional
                      and international members through its office in New York
