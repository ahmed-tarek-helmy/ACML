            ...
            <div className="prose prose-lg dark:prose-invert max-w-none text-gray-700 dark:text-gray-300">
              ...
              <div className="clearfix mb-8">
                ...
                <p className="mb-6 leading-relaxed">
                  ...
                  corporate members, AIAA is the world’s largest technical
                ...
                <p className="mb-6 leading-relaxed">
                  ...
                  1930 as the American Interplanetary Society), and the
                ...
                <p className="leading-relaxed bg-emerald-50 dark:bg-emerald-900/20 p-6 rounded-xl border-l-4 border-emerald-500">
                  This is the place for everything, from exploring our history
                  and purpose … to catching up on the latest news.
                  <br />
                  <br />
                  ...
                  its historic mission is our commitment and our privilege. Now
                  we invite you to learn more about AIAA – and share in the
                  vision and excitement of this inspiring industry.
                </p>
              </div>
