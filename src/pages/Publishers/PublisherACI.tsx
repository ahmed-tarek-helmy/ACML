          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] overflow-hidden p-8 md:p-12 space-y-12 text-gray-700 dark:text-gray-300">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-6">
                <div className="prose prose-lg dark:prose-invert max-w-none text-gray-600 dark:text-gray-300">
                  <p className="mb-4">
                    ...
                    hundreds of technical documents, and offering scholarships
                    to students in the field. With 98 chapters, 37 student
                    chapters, and nearly 20,000 members spanning over 120
                    countries, the American Concrete Institute has always
                    retained the same basic mission - to develop, share, and
            ...
            <section>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-6">
                <div className="prose prose-lg dark:prose-invert max-w-none text-gray-600 dark:text-gray-300">
                  <p className="mb-4">
                    The American Concrete Institute (ACI) is a nonprofit
                    technical and educational society organized in 1904 and is
                    one of the world's leading authorities on concrete
                    technology. ACI is a forum for the discussion of all matters
                    related to concrete and the development of solutions to
                    problems. ACI conducts this forum through conventions and
                    meetings; the ACI Structural Journal, the ACI Materials
                    Journal, Concrete International, and technical publications;
                    chapter activities; and technical committee work. As its
                    mission states, its purpose is to{" "}
                  ...
                  <p className="mb-4">
                    ...
                    benefit of the public at large. By maintaining a high
                    standard of professional and technical ability in its
                    committee memberships and in the authorship of papers and
                    publications, as well as in local chapter programs, ACI has
                    contributed to a detailed knowledge of materials and their
            ...
            <section>
              ...
              <p className="text-gray-600 dark:text-gray-300 text-lg">
                ...
                publications, certification manuals, educational publications,
                and videos.
              </p>
            </section>
          </div>
