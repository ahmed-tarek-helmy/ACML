...
const PublisherHarmattan: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pt-20 transition-colors duration-300">
      <div className="container mx-auto px-4 py-8"><div className="bg-gradient-to-r from-purple-900 to-pink-900 text-white py-20 mb-12 rounded-3xl overflow-hidden shadow-xl">
              ...
              <div className="flex-1">
                ...
                <p className="leading-relaxed mb-6">
                  ...
                  <strong>
                    ...
                    online; 24000 articles; plenty of videos and Audio produts.
                    The Harmattan is leading the publishing in French-speaking
                    countries worldwide, concentrating on humanities; social
                    sciences & history
                  </strong>
                </p>
