            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-500 hover:scale-[1.02] p-8 md:p-12 border border-gray-100 dark:border-gray-700">
              ...
              <div className="prose prose-lg dark:prose-invert max-w-none text-gray-600 dark:text-gray-300">
                ...
                <p className="mb-4">
                  ...
                  rules of safety governing the design, fabrication, maintenance
                  and inspection of boilers and pressure vessels, power
                  producing machines (and associated subsystems) and nuclear
                  power plant components. The objective of the rules is to
                  provide a margin for deterioration in service.
                </p>
                <p className="mb-4">
                ...
                <div className="bg-orange-50 dark:bg-orange-900/20 p-6 rounded-xl my-6 clear-right">
                  <p className="text-gray-700 dark:text-gray-300 font-medium">
                    ...
                    added when advancements are achieved in design and materials
                    and real world experience provides valuable insight.
                  </p>
                </div>
                <p className="mb-4">
                ...
                <p className="mb-4">
                  ...
                  its entirety by all 50 states and numerous municipalities and
                  territories of the United States and all the provinces of
                  Canada. More than 92,000 copies of the BPVC Codes are in use
                  in 100 countries around the world.
                </p>
                <p>
                  The Code is kept current by the Boiler and Pressure Committee,
                  a volunteer group of more than 950 engineers.
                </p>
              </div>
            </div>
          </div>
