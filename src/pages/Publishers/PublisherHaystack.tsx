            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-8 border border-gray-100 dark:border-gray-700">
                ...
                <div className="prose prose-lg dark:prose-invert max-w-none text-gray-600 dark:text-gray-300">
                  ...
                  <p className="mb-4">
                    Accuris Haystack Gold® is our premier parts and logistics
                    product that enables users to find data using a wide range
                    of search criteria across multiple databases, reducing the
                    time spent researching hard-to-find parts while maximizing
                    supply chain effectiveness. This service also provides
                    extensive report capabilities to ensure your part
