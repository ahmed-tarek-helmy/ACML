          ...
          <div className="bg-gradient-to-r from-blue-800 to-indigo-900 text-white py-20 mb-12 rounded-3xl overflow-hidden shadow-xl">
            <div className="container mx-auto px-4 text-center">
              ...
              <p className="text-lg md:text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
                The world's largest digital marketplace for parts and services
                in aviation, marine, and defense.
              </p>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-8 mb-12">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none text-gray-600 dark:text-gray-300">
              <p className="mb-4">
                ...
                subscribers in the aviation and defense industries to buy and
                sell parts, equipment, and services. With over 5 billion parts
                listed, 60,000 customer accesses each day and 22,000
              ...
              <p className="mb-4">
                ...
                rapid information distribution along with maximum security and
                reliability.
              </p>
              <p className="mb-4">
                Headquartered in Memphis, TN, ILS has offices in Atlanta,
                Boston, Dallas, Frankfurt, London, Los Angeles, Miami, New York,
                Paris, Philadelphia, Phoenix, San Diego, Seattle, Shanghai,
                Singapore, St. Louis, and Washington, D.C. ILS is a Boeing
                subsidiary.
              </p>
              <p>
                ILS supply chain solutions assist Aviation & Defense companies
                in managing their supply chain from sourcing to sale. Our
                solutions range from ILSmart, the most active aviation
                marketplace, to supply chain services that manage sales,
                inventory and MRO. ILS provides critical business intelligence
                regarding supply and demand of parts in the worldwide market.
              </p>
            </div>
          </div>
