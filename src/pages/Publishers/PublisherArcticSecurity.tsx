        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-500 hover:scale-[1.02] p-8 md:p-12 border border-gray-100 dark:border-gray-700">
          <div className="space-y-12 text-gray-700 dark:text-gray-300">
            ...
            <section>
              ...
              <p className="leading-relaxed mb-6">
                When it comes to vulnerable services and compromised assets, you
                should know about yours before others do. Early warnings about
                your cybersecurity issues reduce time-to-discovery.
              </p>
              <p className="leading-relaxed mb-6">
            ...
            <section>
              ...
              <p className="leading-relaxed mb-6">
                Improving cybersecurity and reducing cyber risk doesn’t have to
                be mysterious or complicated – the goal is to reach as few and
                as insignificant notifications as possible. Many issues can and
                should be solved by IT staff in the course of their routine
                tasks.
              </p>
              <p className="leading-relaxed mb-6">
                As a change agent in cybersecurity, Arctic Security designed
                Early Warning Service to provide its clients with easy-to-digest
                and actionable information. Not only does this systematically
                build up the capabilities of staff, but it helps you to achieve
                the goal of improving stakeholder cybersecurity posture.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed mb-6">
                ...
                of the established warning systems, and we have seen in practice
                how beneficial that can be.
              </p>
              <p className="leading-relaxed">
                When you perform a cybersecurity assessment for your company, it
                is crucial to have access to a reliable source of information.
                For companies with assets spread over multiple countries, for
                example, Early Warning Service provides additional information
                and improved coverage compared to even national services. Now,
                our Early Warning Service is commercially available to any
