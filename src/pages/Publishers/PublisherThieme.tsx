              ...
              <div className="space-y-8">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-8 border border-gray-100 dark:border-gray-700">
                  ...
                  <div className="prose prose-lg dark:prose-invert max-w-none text-gray-600 dark:text-gray-300 mb-6">
                    <p>
                      The Thieme E-Book Library is an acclaimed online
                      collection of lavishly illustrated full-color downloadable
                      textbooks from Thieme’s renowned Color Atlases and
                      Flexibook series. It is exclusively available by
                      institutional subscription. Each electronic book retains
                      the outstanding educational utility of the print version,
                      including exquisite full-color illustrations and
                      instructive text – plus a powerful search function to help
                      users easily locate topics across the entire collection.
                    </p>
