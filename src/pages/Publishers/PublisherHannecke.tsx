    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pt-20 transition-colors duration-300">
      <div className="mr-20 ml-20">
        <div className="container mx-auto px-4 py-8">
          <div className="bg-gradient-to-r from-gray-900 to-gray-800 text-white py-20 mb-12 rounded-3xl overflow-hidden shadow-xl">
              ...
              <div className="flex flex-col md:flex-row gap-8 items-center">
                <div className="flex-1">
                  <p className="leading-relaxed mb-6">
                    Hannecke is a leading provider of display systems
                    specialized for the presentation of books, magazines,
                    brochures, cards, and multimedia products. Their "Systems"
                    range offers versatile solutions for retail and library
                    environments.
                  </p>
                </div>
