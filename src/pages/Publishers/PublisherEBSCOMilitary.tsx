            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-8 border border-gray-100 dark:border-gray-700">
              ...
              <div className="prose prose-lg dark:prose-invert max-w-none text-gray-600 dark:text-gray-300">
                <p className="mb-4">
                  ...
                  pertinent to the increasing needs of these sites.
                </p>
                <p>
                  <em>Military & Government Collection™</em> provides full text
                  for nearly 300 journals and periodicals. The database also
                  offers indexing and abstracts for more than 400 journals.
                </p>
                <p>
