      ...
      <div className="container mx-auto px-4 py-12 animate-fade-in-up">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] overflow-hidden p-8 md:p-12 space-y-12 text-gray-700 dark:text-gray-300">
          ...
          <section>
            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 p-6 rounded-xl">
              <p className="mb-4">
                ...
                represents a wide cross-section of NDT practitioners working in
                manufacturing, construction, education, research, consulting,
          ...
          <section>
            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 p-6 rounded-xl">
              <p className="mb-4">
                ASNT is a nonprofit corporation governed by a board of directors
                and national officers. The Society is organized into councils
                which govern issues related to 1) Technical and Education, 2)
                Research, 3) Section Operations and 4) Certification. These
                councils meet regularly to achieve the goals and objectives of
                the overall organization. Day to day operations and activities
                are managed by the ASNT International Service Center staff in
                Columbus.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 p-6 rounded-xl">
              <p className="mb-4">
                ...
                organizing and sponsoring conferences and meetings pertaining to
                NDT. Our Annual Conference, Research Symposium, and numerous
                topical conferences attract thousands of participants each year.
                The Society also maintains an extensive publications operation
                which produces and distributes NDT related books, standards,
                technical journals, and training materials
              </p>
