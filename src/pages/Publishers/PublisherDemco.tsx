              ...
              <div className="flex-1 space-y-6 text-gray-700 dark:text-gray-300">
                ...
                <div>
                  ...
                  <p className="leading-relaxed">
                    ...
                    250 coworkers in 2008, with offices in Madison, Wisconsin.
                    The catalog of products has grown from twelve pages to over
                    one thousand. The company added new services, including a
                  ...
                  <p className="leading-relaxed mt-4">
                    ...
                    for the changing demands of library patrons. We can do this
                ...
                <div>
                  ...
                  <p className="leading-relaxed">
                    ...
                    change is always unpredictable. Demco is prepared and looks
                    with enthusiasm toward the many new roles the company can
                    play in helping libraries continue to respond to their
                    communities.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="leading-relaxed">
                    ...
                    educators&rdquo; …now we can call it a century-old
                    tradition. We have the best guarantee in the business. Your
                    complete satisfaction with Demco products is guaranteed. If
                    you're not happy, return it for replacement or full refund.
                    No questions asked! Orders of in-stock products ship the
                    very next day. Just call before noon CST. Save extra on
                    large quantities by contacting our Bids Department.
                  </p>
                  <p className="leading-relaxed mt-4">
                    In keeping with our tradition, we invite you to contact us
                    for whatever you need. One of us will personally answer your
                    call, take your order, answer your questions, or solve your
                    problem. Serving you is what we do best, and we have a
                    hundred years of practice at doing it better than anyone
                    else!
                  </p>
                </div>
              </div>
