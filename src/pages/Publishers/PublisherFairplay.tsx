    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pt-20 transition-colors duration-300">
      <div className="mr-20 ml-20">
        <div className="container mx-auto px-4 py-8">
          <div className="bg-gradient-to-r from-emerald-600 to-teal-700 text-white py-20 mb-12 rounded-3xl overflow-hidden shadow-xl">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 space-y-12 text-gray-700 dark:text-gray-300 border border-gray-100 dark:border-gray-700">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4 flex items-center">
                ...
                About Accuris Fairplay
              </h2>
              <p className="leading-relaxed mb-6">
                Accuris Fairplay brings you the largest maritime database in the
                world, evolved from the Lloyd's Register of Ships published
                since 1764, covering ship characteristics, movements, ownership,
            ...
            <section>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-gray-50 dark:bg-gray-700/50 p-6 rounded-xl">
                  ...
                  <p className="mb-4 text-sm">
                    Complete characteristics of 180,000 ships and 200,000
                    maritime company records including owners, managers, and
                    operators.
                  </p>
                  <ul className="space-y-2">
                    {[
                ...
                <div className="bg-gray-50 dark:bg-gray-700/50 p-6 rounded-xl">
                  ...
                  <p className="mb-4 text-sm">
                    Plan port calls with up-to-date news, analysis of global
                    port security, and detailed data on over 10,000 ports.
                  </p>
                  <ul className="space-y-2">
                    {[
                      "Sea-Sentinel",
                ...
                <div className="bg-gray-50 dark:bg-gray-700/50 p-6 rounded-xl">
                  ...
                  <p className="mb-4 text-sm">
                    Unique analysis of clean and renewable energy markets,
              ...
              <div>
                ...
                <div className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-center">
                      <span className="w-2 h-2 bg-emerald-500 rounded-full mr-2"></span>
                      Accuris Dredging & Port Construction
                    </li>
                  </ul>
                </div>
              </div>
