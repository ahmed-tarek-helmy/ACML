    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pt-20 transition-colors duration-300">
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="md:flex">
            <div className="p-8 md:p-12 md:w-2/3">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed mb-6">
                ACML Company for Integrated Solutions and Systems (ACML 2I2S) is
                pleased to announce that it has officially represented the
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                ...
                years. Teaching Strategies helps early childhood educators build
                effective learning environments and provides a strong foundation
                for every child’s success by connecting teachers, children, and
                families with inspiring learning experiences, meaningful data,
                and stronger partnerships through its leading early learning
                solutions platform.
              </p>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                "Teaching Strategies (TS)" creates a broad and lasting impact by
                empowering and inspiring early childhood educators to
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
            <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
              ...
              that all children deserve a nurturing, engaging, and high-quality
              learning environment designed to support their unique needs
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
            <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
              ...
              teachers, children, and families to inspired teaching and learning
              experiences, informative data, and stronger partnerships.
            </p>
            <div className="rounded-xl overflow-hidden shadow-md">
              <img
                src={teachersImg}
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 mb-16">
          <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
            At{" "}
            <span className="font-bold text-blue-600">Teaching Strategies</span>
            , the work we do together has a wide-reaching impact. By empowering
            and inspiring early childhood educators and providing them with the
            support they need, we’re improving the quality of education for
            young children everywhere and helping them to become lifelong
            creative and confident thinkers.
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden flex flex-col">
              ...
              <div className="p-6 flex-1">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Support children, teachers, and families with our solution for
                  pre-k
                </p>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden flex flex-col">
              ...
              <div className="p-6 flex-1">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  See why our solutions have been chosen by Head Start programs
                  for 40+ years
                </p>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 text-left mt-12 bg-blue-800/50 p-8 rounded-2xl">
            <div>
              ...
              <p className="text-blue-100">
                Connect curriculum, assessment, and professional development to
                promote higher growth and teacher retention.
              </p>
            </div>
            <div>
              <h3 className="text-2xl font-bold text-emerald-400 mb-4">
              ...
              <p className="text-blue-100">
                We reimagined The Creative Curriculum for Preschool with ALL-NEW
                resources and in-the-moment support to make it easier to use
                than ever.
              </p>
            </div>
            <div>
