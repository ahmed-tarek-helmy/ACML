      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="md:flex">
            <div className="p-8 md:p-12 md:w-2/3">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4 font-arabic">
                ...
                الطفولة المبكرة على بناء هذه البيئة، وتوفير أساس النجاح لكل طفل
                من خلال ربط المعلمين والأطفال والأسر بتجارب تعليمية مُلهمة ،
                وبيانات فعالة، وشراكات أقوى من خلال منصة حلول التعلم المبكر
                الرائدة.
              </p>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                أن "استراتيجيات التدريس"Teaching Strategies (TS) ، تحدث تأثيرًا
                واسع النطاق من خلال تمكين وإلهام مُعلّمي مرحلة الطفولة المبكرة
                علي التعامل مع الاطفال في الفترة العمرية من (1-8) سنوات وتوفير
                الدعم اللازم لهم ، وتحسين جودة التعليم للأطفال الصغار.
              </p>
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
            <p className="text-lg text-gray-700 dark:text-gray-300 mb-6 font-arabic">
              ...
              كل طفل، من خلال ربط المعلمين والأطفال والأسر بتجارب تعليمية ملهمة،
              وبيانات تعليمية فعّالة، وشراكات أقوى عبر منصة رائدة وحلول متكاملة
              للتعلم المبكر.
            </p>
            <div className="rounded-xl overflow-hidden shadow-md">
              <img
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 mb-16">
          <p className="text-lg text-gray-700 dark:text-gray-300 mb-6 font-arabic">
            ...
            بتحسن جودة التعليم للأطفال الصغار في جميع أنحاء العالم، ونساعدهم على
            أن يصبحوا مفكرين أو مبدعين وواثقين مدى الحياة.
          </p>
        ...
        <div className="bg-blue-900 text-white rounded-3xl p-12 mb-16 text-center shadow-xl font-arabic">
          <p className="text-xl mb-8 leading-relaxed">
            ...
            دولة حول العالم. وتضع حلولها الحائزة على جوائز دولية معيارًا عالميًا
            للتميّز في تعليم الطفولة المبكرة.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 text-right mt-12 bg-blue-800/50 p-8 rounded-2xl">
            ...
            <div>
              ...
              <p className="text-blue-100">
                ...
                المدرسة بالكامل، مع موارد جديدة كليًا ودعم فوري داخل الصف، ليصبح
                أسهل في الاستخدام وأكثر فاعلية من أي وقت مضى.
              </p>
            </div>
            <div>
              <h3 className="text-2xl font-bold text-emerald-400 mb-4">
              ...
              <p className="text-blue-100">
                تعرّف على دور المنهج الخلاق Creative Curriculum ونظامنا المتكامل
                في رفع معدلات الاحتفاظ بالمعلمين بنسبة 54%، وتحسين النتائج
                الأكاديمية للأطفال في مختلف المجالات.
              </p>
            </div>
            <div>
              <h3 className="text-2xl font-bold text-emerald-400 mb-4">
