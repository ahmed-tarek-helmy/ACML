          ...
          <div className="prose prose-lg dark:prose-invert max-w-none text-gray-600 dark:text-gray-300">
            ...
            <div className="bg-emerald-50 dark:bg-emerald-900/20 p-6 rounded-xl border border-emerald-100 dark:border-emerald-800">
              <p className="font-bold text-gray-900 dark:text-white mb-2">
                ACML is the Authorized EndNote Distributor for the following 23
                Arab countries:
              </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-2">
              ...
              files (PDFs, images) per reference. Find full text automatically.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-2">
              Create instant bibliographies in Microsoft Word, Apple Pages, and
              more. Watch the bibliography appear as you type. Includes over
        ...
        <div className="space-y-12 mb-12">
          ...
          <section>
            ...
            <ul className="grid md:grid-cols-2 gap-4 text-gray-700 dark:text-gray-300">
              ...
              <li className="flex items-start">
                <span className="text-blue-500 mr-2">•</span>Access hundreds of
                remote databases (Web of Science, Ovid, PubMed, Library of
                Congress).
              </li>
              <li className="flex items-start">
          ...
          <section>
            ...
            <ul className="space-y-3 text-gray-700 dark:text-gray-300">
              ...
              <li className="flex items-start">
                ...
                (auto-update), and combined groups. Drag-and-drop organization.
              </li>
              <li className="flex items-start">
                <span className="text-amber-500 mr-2">•</span>
              ...
              <li className="flex items-start">
                <span className="text-amber-500 mr-2">•</span>
                <strong>Preview & Edit:</strong> Preview in 5,000+ styles. Quick
                Edit tab for modifying while viewing PDFs.
              </li>
              <li className="flex items-start">
                <span className="text-amber-500 mr-2">•</span>
              ...
              <li className="flex items-start">
                <span className="text-amber-500 mr-2">•</span>
                <strong>Global Editing:</strong> Change Text, Change Field, Move
                Field commands for mass updates.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="space-y-3 text-gray-700 dark:text-gray-300">
              <li className="flex items-start">
                ...
                Word, Apple Pages, OpenOffice, Mathematica. Citations appear as
                you write.
              </li>
              <li className="flex items-start">
                <span className="text-green-500 mr-2">•</span>
          ...
          <section>
            ...
            <ul className="grid md:grid-cols-2 gap-4 text-gray-700 dark:text-gray-300">
              ...
              <li className="flex items-start">
                <span className="text-purple-500 mr-2">•</span>Share EndNote Web
                groups to simplify collaboration.
              </li>
              <li className="flex items-start">
