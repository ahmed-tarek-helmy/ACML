            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-8 border border-gray-100 dark:border-gray-700">
              ...
              <div className="prose prose-lg dark:prose-invert max-w-none text-gray-600 dark:text-gray-300">
                ...
                <p className="mb-4">
                  ...
                  gap in legal history by providing comprehensive coverage from
                  inception of more than 1,400 law and law-related periodicals.
                </p>
                <p className="mb-4">
                  In addition to its vast collection of law journals, HeinOnline
                  also contains the Congressional Record Bound volumes in
                  entirety, complete coverage of the U.S. Reports back to 1754,
                  famous world trials dating back to the early 1700′s, legal
                  classics from the 16th to the 20th centuries, the United
                  Nations and League of Nations Treaty Series, all United States
                  Treaties, the Federal Register from inception in 1936, the CFR
                  from inception in 1938, and much more.
                </p>
                ...
                <p>
                  ...
                  years as a legal publisher, periodical subscription agent, and
                  the world’s largest distributor of legal periodicals.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    ...
                    including a core subscription package which includes the Law
                    Journal Library, Federal Register/CFR, U.S. Code, U.S.
                    Supreme Court Library, Legal Classics, U.S. Presidential
                    Library, Treaties & Agreements, English Reports, U.S.
                    Statutes at Large, U.S. Federal Legislative History Library,
                    U.S. Attorney General Opinions, European Center for Minority
                    Issues, Manual of Patent Examining Procedure, Trends in Law
                    Library Management and Technology, American Association of
                    Law Libraries, and Association of American Law Schools.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    There are also a variety of a-la-carte libraries that can be
                    added to a subscription to create a powerful legal research
                    collection. Some of these libraries include the U.S.
                    Congressional Documents, United Nations Law Collection,
                    Subject Compilations of State Laws, Kluwer Law International
                    Journal Library, and more!
                  </p>
                </div>
