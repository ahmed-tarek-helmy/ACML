      ...
      <div className="container mx-auto px-4 py-8">{/* Hero Section */}
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 mb-12 text-gray-700 dark:text-gray-300 border border-gray-100 dark:border-gray-700">
          ...
          <p className="leading-relaxed mb-4">
            Jaypeedigital is powerful, unparalleled comprehensive online health
            science platform for health care practitioners, educators,
            ...
            cutting edge high quality videos from the best minds in the industry
            across the globe.
          </p>
          <p className="leading-relaxed">
            ...
            health sciences subjects to meet the diverse need of health science
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-8 hover:shadow-lg transition-all">
            ...
            <ul className="space-y-4 text-gray-600 dark:text-gray-300">
              ...
              <li className="flex items-start">
                <span className="w-2 h-2 bg-emerald-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                <span>
                  2200+ Professional and Reference books from the best minds in
                  the industry.
                </span>
              </li>
              <li className="flex items-start">
                <span className="w-2 h-2 bg-emerald-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                <span>
                  Thousands of MCQs, SBAs, SCE and other preparatory books like
                  USMLE, MRCP, FRCS, hands on guides to laboratory studies,
                  clinical diagnosis and experimental techniques.
                </span>
              </li>
              <li className="flex items-start">
                <span className="w-2 h-2 bg-emerald-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                <span>Personalized features: bookmarking, notes, export.</span>
              </li>
              <li className="flex items-start">
                <span className="w-2 h-2 bg-emerald-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                <span>
