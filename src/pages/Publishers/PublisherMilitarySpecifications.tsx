              ...
              <div className="flex flex-col md:flex-row gap-8 items-start">
                <div className="flex-1">
                  <p className="leading-relaxed mb-4">
                    The Accuris Military product line offers a variety of
                    specifications and standards solutions needed for research
                    and design, purchasing, bidding, logistics and related
                    applications. It simplifies the complicated research
                    associated with military contracts and can help you comply
                    with ISO 9000 series standards and other quality
                    initiatives.
                  </p>
                  <p className="leading-relaxed mb-4">
                  ...
                  <p className="leading-relaxed mb-4">
                    ...
                    the more than 1.3 M technical standards and related
                    documents in the Specs & Standards Index. Specs & standards
                    is the world's largest bibliographical database of active
                    and historical standards, specifications, drawings,
                    handbooks and related technical documents.
                  </p>
                </div>
              </div>
            </section>
