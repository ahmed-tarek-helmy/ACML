          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-8 border border-gray-100 dark:border-gray-700">
              ...
              <div className="prose prose-lg dark:prose-invert max-w-none text-gray-600 dark:text-gray-300">
                ...
                <p>
                  <strong>GlobalTradeTracker</strong> offers powerful web-based
                  access to original trade statistics from the world’s leading
                  trading nations, giving you a clear objective picture of the
                  trade flows you need to know about. Lightning fast updating,
                  flexible output options and tailored payment plans makes
                  Global Trade Tracker the service of choice for business
                  analysts worldwide.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-8 border border-gray-100 dark:border-gray-700">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                ...
                service that gives access to original trade statistics from the
                world's principal trading countries. Unlike some other services,
                GTT does not manipulate the data in any way – giving you a
                clear, objective picture of the trade flows you need to know
                about.
              </p>
              <p className="text-gray-600 dark:text-gray-300">
                Currently around 75 countries and growing report to Global Trade
                Tracker. Statistics are obtained from the official customs or
                national statistics office of each country.
              </p>
            </div>
          </div>
