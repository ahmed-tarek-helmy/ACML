        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2
              ...
              className="text-3xl font-bold text-gray-900 dark:text-white mb-8 text-center scroll-mt-24"
            >
              Group of Advisors
            </h2>
            <p className="text-center text-gray-600 dark:text-gray-300 mb-12 max-w-2xl mx-auto">
              ACML has appointed a distinguished group of advisors in all fields
              related to its activities to advise and inspire ACML staff and
              clients.
            </p>
