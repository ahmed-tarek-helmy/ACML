...
export default function Chairman({ setCurrentPage }: ChairmanProps) {
  return (
    <div className="pt-20">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-100 dark:border-gray-700 flex flex-col md:flex-row gap-12 items-center">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <div className="space-y-4">
                  <button 
                    onClick={() => setCurrentPage('about-chairman-ar')}
                  ...
                  >
                    ...
                    <Globe className="ml-auto text-gray-400 group-hover:text-emerald-500" size={18} />
                  </button>
                  ...
                  >
                    ...
                    <Download className="ml-auto text-gray-400 group-hover:text-emerald-500" size={18} />
                  </a>
